...
import img1 from "/src/assets/CottageCore/img1.jpg"
import img2 from "/src/assets/CottageCore/img2.jpg"
import img3 from "/src/assets/CottageCore/img3.jpg"
import img4 from "/src/assets/CottageCore/img4.jpg"
import img5 from "/src/assets/CottageCore/img5.jpg"
import img6 from "/src/assets/CottageCore/img6.jpg"
import img7 from "/src/assets/CottageCore/img7.jpg"
import img8 from "/src/assets/CottageCore/img8.jpg"
import img9 from "/src/assets/CottageCore/img9.jpg"
  ...
  return (
    <>
       <div className="font-custom-h flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-900 px-3 pt-2 text-lg break-words max-w-3xl">
          The Y2K-inspired outfit is all about embracing the bold, playful, and futuristic aesthetics of the late ‘90s and early 2000s. 
          Think shiny fabrics, low-rise jeans, baby tees, chunky sneakers, and statement accessories like tiny sunglasses and butterfly clips.
        </p>
      </div>
